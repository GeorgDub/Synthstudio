...
| **Multi-Window Dockable Workspace — Generalisierung** | Verbleibend: Audio Workbench (braucht Live-Audio-Playback + Canvas-Waveform-Forwarding), Script Runner (braucht IPC-Bridge für Sandbox-Calls — komplex), Channel Inspector (lots of state broadcasting needed), GeneratorView (ist .jsx, würde TS-Migration brauchen), Settings, ArpeggiatorPanel. Mit 8 Templates verfügbar (Performance-Popup, FX-Window, Mixer-Window, Sample-Browser-Window, Pattern-Generator-Window, KeyboardSampler-Window, ChordProgression-Window, PatternLibrary-Window) + Window-Layout-Persistenz. | 1-2 Wochen |
