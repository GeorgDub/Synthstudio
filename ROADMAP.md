...
| **Multi-Window Dockable Workspace — Generalisierung** | Verbleibend: Audio Workbench (braucht Live-Audio-Playback + Canvas-Waveform-Forwarding), Script Runner (braucht IPC-Bridge für Sandbox-Calls — komplex), Settings, Chord Progression Panel, Keyboard Sampler Panel. Voraussetzungen: (a) Web-Fallback via `window.open`, (b) Keyboard-Shortcuts zum Detach/Reattach. Mit FX-Window, Performance-Popup, Mixer-Window, Sample-Browser-Window, Pattern-Generator-Window sind jetzt fünf Templates verfügbar plus Window-Layout-Persistenz aktiv. | 1-2 Wochen |
