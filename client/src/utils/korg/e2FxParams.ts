/**
 * e2FxParams.ts — FX-Typen + Parameter-Namen für die Korg-E2/hacktribe-FX-Steuerung.
 *
 ...
 *
 * Die Param-Index-Position (0-basiert) == NRPN DATA-MSB (siehe e2Nrpn.buildFxEdit).
 * Werte sind 0..127 (Int8ul über NRPN). **Semantische Min/Max/Einheiten sind im
 * hacktribe-editor NICHT hinterlegt** (dort als TODO markiert) — daher hier nur
 * Namen; Ranges = 0..127. Der FX-**Typ** wird NICHT per NRPN gesetzt, sondern im
 * Preset/RAM-Edit-Buffer; NRPN editiert nur Params des bereits geladenen FX.
 */
