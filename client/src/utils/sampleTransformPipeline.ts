 ...
 *   2. reverseSample (wenn options.reverse)
 *   3. fadeInSample  (wenn options.fadeInMs > 0)
 *   4. fadeOutSample (wenn options.fadeOutMs > 0)
 *   5. autoNormalize (wenn options.normalize)
 *
