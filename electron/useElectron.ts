...
const browserAPI = {
  ...
  setKeyboardSamplerWindowAlwaysOnTop: async (_aot: boolean) => ({ success: false, alwaysOnTop: false }),
  isKeyboardSamplerWindowAlwaysOnTop: async () => false,
  sendKeyboardSamplerPopupState: (_state: unknown) => {},
  sendKeyboardSamplerPopupAction: (_action: unknown) => {},
  onKeyboardSamplerPopupState: noopDataListener<unknown>(),
  onKeyboardSamplerPopupAction: noopDataListener<unknown>(),
  ...
  setChordProgressionWindowAlwaysOnTop: async (_aot: boolean) => ({ success: false, alwaysOnTop: false }),
  isChordProgressionWindowAlwaysOnTop: async () => false,
  sendChordProgressionPopupState: (_state: unknown) => {},
  sendChordProgressionPopupAction: (_action: unknown) => {},
  onChordProgressionPopupState: noopDataListener<unknown>(),
  onChordProgressionPopupAction: noopDataListener<unknown>(),
  ...
  setPatternLibraryWindowAlwaysOnTop: async (_aot: boolean) => ({ success: false, alwaysOnTop: false }),
  isPatternLibraryWindowAlwaysOnTop: async () => false,
  sendPatternLibraryPopupState: (_state: unknown) => {},
  sendPatternLibraryPopupAction: (_action: unknown) => {},
  onPatternLibraryPopupState: noopDataListener<unknown>(),
  onPatternLibraryPopupAction: noopDataListener<unknown>(),
  ...
  onMenuTab: noopDataListener<string>(),
...
export function useElectron() {
  ...
  return {
    ...
    notifyThemeChanged: api.notifyThemeChanged,
