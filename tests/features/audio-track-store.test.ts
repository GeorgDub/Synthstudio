...
describe("projectSerializer × audioTracks", () => {
  ...
  it("SYNTH_FILE_VERSION ist '1.18' (audioTracks bleiben kompatibel)", () => {
    // v1.18 bumpt für liveInputs/midiNoteOut/slicePads; audioTracks (seit v1.15)
    // bleiben additiv-kompatibel.
  ...
  it("Serializer Round-trip: serialize → JSON → parse erhält audioTracks", () => {
    ...
    expect(restored.version).toBe("1.18");
  });
